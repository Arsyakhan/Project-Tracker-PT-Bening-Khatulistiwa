        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative z-20">
          <div className="w-full max-w-sm">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border border-line bg-panel hover:bg-canvas text-ink rounded-md py-3 text-sm font-medium transition-colors shadow-sm"
            >
